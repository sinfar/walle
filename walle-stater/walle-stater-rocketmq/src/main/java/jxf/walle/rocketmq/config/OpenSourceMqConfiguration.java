package jxf.walle.rocketmq.config;
...
import jxf.walle.rocketmq.consumer.opensource.OpenSourceConsumerContainerBuilder;
...
@Configuration
public class OpenSourceMqConfiguration {
