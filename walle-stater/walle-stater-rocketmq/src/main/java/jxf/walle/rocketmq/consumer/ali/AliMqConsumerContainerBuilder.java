package jxf.walle.rocketmq.consumer.ali;
...
public class AliMqConsumerContainerBuilder implements ConsumerContainerBuilder {
    ...
    private final AliMqConfiguration aliMqProducerConfiguration;


    public AliMqConsumerContainerBuilder(AliMqConfiguration aliMqProducerConfiguration, JavaTimeModule javaTimeModule) {
